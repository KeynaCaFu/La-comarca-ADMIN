                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="proveedores[]" 
                                       ...
                                       {{ in_array($proveedor->proveedor_id, old('proveedores', [])) ? 'checked' : '' }}>
                            ...
                            <p class="text-muted">No hay proveedores activos. <a href="{{ route('proveedores.create') }}">Crear proveedor</a></p>
                            @endif
                        </div>
                    </div>
